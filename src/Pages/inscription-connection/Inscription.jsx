...
export default function Inscription({setIsAuthenticated}) {
  ...
  return (
    <MDBContainer
      fluid
      className="px-5 background-radial-gradient overflow-hidden"
    >
      <Toaster />
      <MDBRow>
        <MDBCol
          md="7"
          sm="12"
          className="text-center text-md-start d-flex flex-column justify-content-center p-5"
        >
          <h1
          ...
          >
            ...
            Découvrez un univers foisonnant de savoirs et d'épopées, où chaque
            page devient le point de départ d'une aventure inoubliable.
          </p>
        </MDBCol>
